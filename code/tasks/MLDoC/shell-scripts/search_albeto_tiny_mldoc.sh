...
for bs in "${batch_sizes[@]}"; do
    for lr in "${learning_rates[@]}"; do
        for n_epoch in "${epochs[@]}"; do
            ...
            --output_dir /data/jcanete/all_results/mldoc/albeto_tiny/epochs_"$n_epoch"_bs_"$bs"_lr_"$lr" \
            ...
            --logging_dir /data/jcanete/all_results/mldoc/albeto_tiny/epochs_"$n_epoch"_bs_"$bs"_lr_"$lr" \
            --seed 42 \
