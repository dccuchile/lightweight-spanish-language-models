...
def main():
    ...
    if training_args.do_train:
        ...
        label_list = train_dataset.features[f"upos"].feature.names

    if training_args.do_eval:
        eval_dataset = load_dataset(DATASET, LANGUAGE,
                                    split="validation",
                                    cache_dir=model_args.cache_dir)
        label_list = eval_dataset.features[f"upos"].feature.names

    if training_args.do_predict:
        test_dataset = load_dataset(DATASET, LANGUAGE, split="test",
                                    cache_dir=model_args.cache_dir)
        label_list = test_dataset.features[f"upos"].feature.names
