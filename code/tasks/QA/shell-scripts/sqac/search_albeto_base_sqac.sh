...
for bs in "${batch_sizes[@]}"; do
    for lr in "${learning_rates[@]}"; do
        for n_epoch in "${epochs[@]}"; do
            ...
            --output_dir /data/jcanete/all_results/sqac/albeto_base/epochs_"$n_epoch"_bs_64_lr_"$lr" \
            --do_train \
            --do_eval \
            ...
            --logging_dir /data/jcanete/all_results/sqac/albeto_base/epochs_"$n_epoch"_bs_64_lr_"$lr" \
            --seed 42 \
