...
class ModelArguments:
    ...
    freeze_embeddings: bool = field(
        default=False,
        metadata={
            "help": "Whether to freeze the embeddings of the model to not be updated during training."
        },
    )
...
def main():
    ...
    if model_args.freeze_embeddings:
        modules = [model.albert.embeddings]
        logger.info(f"Freezing the following parameters: {modules}")
